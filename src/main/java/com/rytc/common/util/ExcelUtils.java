...
import com.rytc.common.handler.ExportHandler;
import com.rytc.common.util.poi.convert.ExportConvert;
import com.rytc.common.util.poi.pojo.ExportItem;
...
public class ExcelUtils {
	...
	private void required$BuilderParams() {
		if (mClass == null) {
			throw new IllegalArgumentException("请先使用com.rytc.util.ExcelUtils.$Builder(Class<?>)构造器初始化参数。");
		}
	}
	...
	private void required$ExportParams() {
		if (mClass == null || mResponse == null) {
			throw new IllegalArgumentException(
					"请先使用com.rytc.util.ExcelUtils.$Export(Class<?>, HttpServletResponse)构造器初始化参数。");
		}
